export default function ActivityLevelOption({
  ...
  const base =
    "w-full max-w-xs p-5 cursor-pointer rounded-md text-center font-sans transition-all duration-200 border flex flex-col items-center justify-center gap-2";
