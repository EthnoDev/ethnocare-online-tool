    ...
    <>
      ...
      >
        <PageTransitionWrapper>
          <div
            className="bg-white p-6 rounded-xl shadow-xl relative w-full max-w-sm text-center font-sans pointer-events-auto border border-gray-100 max-h-[90vh] overflow-y-auto"
          ...
          >
            ...
            <div className="mt-3 text-sm text-slate-500 space-y-1 leading-relaxed">
              <p>
                <Trans
                  ns="common"
